...
set landsight to Minmus:geopositionlatlng(4.3,76.3).
print "load mode1.ks".
require("minmus_chelnok_1","launch-inclan.ks").
require("minmus_chelnok_1","minmus_node.ks").
require("libwarp","warpheight.ks").
require("liborbital","exenode.ks").
require("libscience","do_science.ks").
require("liborbital","perinode.ks").
require("minmus_chelnok_1","landing.ks").
require("minmus_chelnok_1","satprogram-inclan.ks").
