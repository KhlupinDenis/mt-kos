...
function landlongnode {

    parameter lorb.	// peri = altitude to begin descent from.
    //parameter DeorbitLongitude IS 42.	// 47 degrees sets Kerbin directly overhead, but the lander takes about 5 degrees to land.
    parameter DeorbitLongitude.	// 47 degrees sets Kerbin directly overhead, but the lander takes about 5 degrees to land.
